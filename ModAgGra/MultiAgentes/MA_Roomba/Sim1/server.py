from model import RoombaModel, ObstacleAgent, DirtAgent, ChargingStationAgent
...
model_params = {"DirtN": Slider("Dirt Amount", 20, 1, 15*(15/4), 1), 
                "ObsN": Slider("Obstacles Amount", 10, 1, 15*(15/4), 1), 
                "width":15,
                "height":15}
